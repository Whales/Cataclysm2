...
{
  switch (id) {
    case STAT_NULL:         return "NULL";
    case STAT_STRENGTH:     return "strength";
    case STAT_DEXTERITY:    return "dexterity";
    case STAT_INTELLIGENCE: return "intelligence";
    case STAT_PERCEPTION:   return "perception";
    case STAT_MAX:          return "BUG - STAT_MAX";
    default:                return "BUG - Unnamed Stat_id";
  }
...
std::string stat_id_short_name(Stat_id id)
{
  switch (id) {
    ...
    case STAT_PERCEPTION:   return "per";
    case STAT_MAX:          return "BUG - STAT_MAX";
    default:                return "BUG - Unnamed Stat_id";
  }
...
{
  switch (op) {
    case MATH_NULL:                     return "NULL";
    case MATH_MULTIPLY:                 return "*";
    case MATH_GREATER_THAN:             return ">";
    case MATH_GREATER_THAN_OR_EQUAL_TO: return ">=";
    case MATH_LESS_THAN:                return "<";
    case MATH_LESS_THAN_OR_EQUAL_TO:    return "<=";
    case MATH_EQUAL_TO:                 return "=";
    case MATH_MAX:                      return "BUG - MATH_MAX";
    default:                            return "BUG - Unnamed Math_operator";
  }
